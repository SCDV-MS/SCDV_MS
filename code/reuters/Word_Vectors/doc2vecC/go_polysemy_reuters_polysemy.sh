...
gshuf reuters_polysemy_text1_annotated.txt > reuters_polysemy_text1_annotated-shuf.txt
...
time ./doc2vecc -train ../../data/reuters_polysemy_text1_annotated-shuf.txt -word wordvectors_reuters_polysemy_5.txt -output ../../data/docvectors_polysemy.txt -cbow 1 -size 200 -window 10 -negative 5 -hs 0 -sample 0 -threads 4 -binary 0 -iter 100 -min-count 5 -test ../../data/reuters_polysemy_text1_annotated.txt -sentence-sample 0.1 -save-vocab ../../data/alldata_polysemy.vocab
